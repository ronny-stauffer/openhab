...
public class CoreItemFactory implements ItemFactory {
	...
	private static String[] ITEM_TYPES = new String[] { "Switch", "Rollershutter", "Contact", "String", "Number", "Dimmer", "DateTime", "Color", "Jalousie" };
	...
	public GenericItem createItem(String itemTypeName, String itemName) {
		...
		if (itemTypeName.equals(ITEM_TYPES[8])) return new JalousieItem(itemName);
		else return null;
	}
